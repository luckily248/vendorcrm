...
func initApp() {
	...
	//Config, err := revel.LoadMimeConfig("app.conf")
	//if err != nil || Config == nil {
	//	log.Fatalf("%+v", err)
	//}

	//port := revel.Config.StringDefault("http.port", "6666")
	//println("port:" + port)
	mongodb.MaxPool = revel.Config.IntDefault("mongo.maxPool", 0)
	mongodb.PATH = revel.Config.StringDefault("mongo.path", "localhost")
	println("PATH:"+mongodb.PATH)
